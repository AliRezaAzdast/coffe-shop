...
export default function Products({ cart, setCart }) {  
  ...
  return (
    <section className="products pt-8 md:pt-24 lg:pt-48 mb-8 md:mb-12 lg:mb-20">
            ...
            {showAlert && (
                ...
                {/* products items */}
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[14px] lg:gap-5">
                   {productData.map(data => {
                    if(data.quantity == 0){
                        return (
                            <div key={data.id} className="dark:bg-zinc-700 bg-white shadow-normal rounded-2xl p-5">
                    ...
                    {/* product item svg */}
                       ...
                       return (
                        ...
                        return(<div key={data.id} className="dark:bg-zinc-700 bg-white shadow-normal rounded-2xl p-5">
                            <img src={data.img} alt="" loading="lazy" className="w-32 mx-auto md:w-auto" />
                            <p className="font-DanaMedium text-sm lg:text-xl h-[40px] md:h-[56px] text-zinc-700 dark:text-white mt-5 mb-[10px] line-clamp-2">{data.productName}</p>
                            <div className="mb-5">
